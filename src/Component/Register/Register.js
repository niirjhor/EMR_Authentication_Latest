        ...
        <form class="row g-2">
          ...
          <div class="col-12 text-center g-1">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <p class="text-muted">
                        Enter the confirmation code sent to n****r@gmail.com and
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form>
                      <h2 class="fw-bold">Enter the confirmation code</h2>
                      <p class="text-muted">
                        Enter the confirmation code sent to n**ro*jh@gmail.com
            ...
            <button
              ...
              data-bs-whatever="@mdo"
            >
              Register As Medical Representative
            </button>
            ...
            >
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <p class="text-muted">
                        ...
                        nir**or.ta**us@gmail.com and follow the steps to
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-dark">
                      <a class="nav-link text-white" href="/medicalrep">
                        Verify
                      </a>
                    </button>
                  </div>
